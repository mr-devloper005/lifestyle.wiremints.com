...
const desks = [
  ...
  { icon: Megaphone, title: 'Media partnerships', body: 'Discuss distribution, syndication, visibility support, and campaigns.' },
    ...
    <EditableSiteShell>
      <main className="bg-white text-[#111]">
        ...
        <section className="mx-auto grid max-w-[var(--editable-container)] border-x border-black bg-white lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="border-b border-black bg-black text-white lg:border-b-0 lg:border-r">
