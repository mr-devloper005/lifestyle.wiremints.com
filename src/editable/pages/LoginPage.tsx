    ...
    <EditableSiteShell>
      <main className="bg-white text-[#111]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] border-x border-black bg-white lg:grid-cols-[1.08fr_0.92fr]">
          <div className="flex flex-col justify-center border-b border-black bg-black p-8 text-white sm:p-12 lg:border-b-0 lg:border-r lg:p-16">
          ...
          <div className="flex flex-col justify-center p-7 sm:p-12 lg:p-16">
            ...
            <p className="mt-5 border-t border-black pt-5 text-sm text-black/65">New here? <Link href="/signup" className="font-black underline decoration-[var(--slot4-accent)] decoration-4 underline-offset-4">{pagesContent.auth.login.createCta}</Link></p>
          </div>
        </section>
      </main>
    </EditableSiteShell>
